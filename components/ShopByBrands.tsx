        ...
        <div className="animate-marquee gap-6">
          {[...brands, ...brands].map((brand, index) => (
            <Link
              ...
              className="bg-white w-40 h-24 shrink-0 flex items-center justify-center rounded-md overflow-hidden hover:shadow-lg shadow-shop_dark_green/20 hoverEffect"
            >
              {brand?.image && (
                <Image
